...
<!--	<el-form-item label="Photo" prop="photo">
	    ...
	    <img v-if="employeForm.userProfilePic" :src="employeForm.userProfilePic" class="avatar">
            <i v-else class="el-icon-plus avatar-uploader"></i>
	  </el-upload>
</el-form-item>-->
	...
	<el-form-item :label-width="labelWidth" label="Numéro matricule" prop="matricule">
	  <el-input v-model="employeForm.registrationNumber"></el-input>
	</el-form-item>
	...
	<el-form-item :label-width="labelWidth" label="Fonction" prop="matricule">
	  <el-input v-model="employeForm.office"></el-input>
	</el-form-item>

	<el-form-item :label-width="labelWidth" label="Catégorie" prop="matricule">
	  <el-input v-model="employeForm.category"></el-input>
	</el-form-item>
	...
	<el-form-item :label-width="labelWidth" label="Mode de payement" prop="matricule">
	  <el-input v-model="employeForm.paymentMethod"></el-input>
	</el-form-item>
  ...
  methods: {
    ...
    ajouterEmploye() {
      const emp = {
        ...
        'registrationNumber': this.employeForm.registrationNumber,
        ...
        'office': this.employeForm.office,
        'category': this.employeForm.category,
        'paymentMethod': this.employeForm.paymentMethod,
